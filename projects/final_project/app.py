...
conn = sqlite3.connect('/home/cheara01/CS330/projects/final_project/database.db')
   ...
   if request.method == 'POST':
      try:
          if len(request.form['genre']) == 6:
            ...
            with sql.connect("'/home/cheara01/CS330/projects/final_project/database.db'") as con:
                cur = con.cursor()
...
@app.route("/action")
def action():
    con = sql.connect("'/home/cheara01/CS330/projects/final_project/database.db'")
